...
namespace Performance_Appraisal_System.Models
{
    ...
    public partial class Report37
    {
        ...
        [DisplayName("मागील आर्थिक वर्षातील कारवाईसाठी प्रलंबित असलेले प्रशासकीय अहवाल संख्या")]
        [RegularExpression("([0-9][0-9]*[.]*)", ErrorMessage = "फक्त संख्या प्रविष्ट करा")]
        public Nullable<int> Last_Year_Pending { get; set; }


        [Required(ErrorMessage = "कृपया अहवाल संख्या आवश्यक आहे")]
        [DisplayName("चालु आर्थिक वर्षात मागील महिनाअखेर प्राप्त झालेल्या प्रशासकीय अहवालांची संख्या")]
        [RegularExpression("([0-9][0-9]*[.]*)", ErrorMessage = "फक्त संख्या प्रविष्ट करा")]
        ...
        [Required(ErrorMessage = "कृपया अहवाल संख्या आवश्यक आहे")]
        [DisplayName("एकुण  प्राप्त प्रशासकीय अहवाल संख्या")]
        [RegularExpression("([0-9][0-9]*[.]*)", ErrorMessage = "फक्त संख्या प्रविष्ट करा")]
