...
insert into Subjects values(N'(1) महाराष्ट्र सावकारी (नियमन) अधिनियम 2014 मधील नियम 16 अन्वये तक्रारी बाबत',10,2)
...
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR1',N'मुंबई','DJR123',1,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR2',N'पुणे','DJR123',2,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR3',N'कोल्हापूर','DJR123',3,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR4',N'नाशिक','DJR123',4,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR5',N'औरंगाबाद','DJR123',5,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR6',N'लातूर','DJR123',6,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR7',N'अमरावती','DJR123',7,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR8',N'नागपूर','DJR123',8,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR9',N'कोकण','DJR123',9,3,1,1)
go


insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR1',N'मुंबई शहर - 1','DDR123',1,1,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR2',N'मुंबई शहर - 2','DDR123',1,2,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR3',N'मुंबई शहर - 3','DDR123',1,3,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR4',N'मुंबई शहर - 4','DDR123',1,4,4,1,2)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR5',N'पुणे शहर','DDR123',2,5,4,1,3)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR6',N'पुणे ग्रामिण','DDR123',2,6,4,1,3)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR7',N'सोलापूर','DDR123',2,7,4,1,3)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR8',N'कोल्हापूर','DDR123',3,8,4,1,4)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR9',N'सातारा','DDR123',3,9,4,1,4)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR10',N'सांगली','DDR123',3,10,4,1,4)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR11',N'नाशिक','DDR123',4,11,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR12',N'धुळे','DDR123',4,12,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR13',N'नंदुरबार','DDR123',4,13,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR14',N'जळगाव','DDR123',4,14,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR15',N'अहमदनगर','DDR123',4,15,4,1,5)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR16',N'औरंगाबाद','DDR123',5,16,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR17',N'जालना','DDR123',5,17,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR18',N'परभणी','DDR123',5,18,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR19',N'हिंगोली','DDR123',5,19,4,1,6)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR20',N'लातूर','DDR123',6,20,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR21',N'उस्मानाबाद','DDR123',6,21,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR22',N'नांदेड','DDR123',6,22,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR23',N'बीड','DDR123',6,23,4,1,7)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR24',N'अमरावती','DDR123',7,24,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR25',N'अकोला','DDR123',7,25,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR26',N'वाशिम','DDR123',7,26,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR27',N'यवतमाळ','DDR123',7,27,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR28',N'बुलढाणा','DDR123',7,28,4,1,8)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR29',N'नागपूर','DDR123',8,29,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR30',N'वर्धा','DDR123',8,30,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR31',N'चंद्रपूर','DDR123',8,31,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR32',N'भंडारा','DDR123',8,32,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR33',N'गोंदीया','DDR123',8,33,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR34',N'गडचिरोली','DDR123',8,34,4,1,9)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR35',N'पालघर','DDR123',9,35,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR36',N'ठाणे','DDR123',9,36,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR37',N'रत्नागिरी','DDR123',9,37,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR38',N'रायगड','DDR123',9,38,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR39',N'सिंधुदुर्ग','DDR123',9,39,4,1,10)
go
