...
insert into Users(UserName,Name,Password,RoleId,Status) values('comm1',N'सह्कार आयुक्त','ev1t/osfpMghRuzlR7XZ1g==',2,1)
go


insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR1',N'मुंबई विभाग','8NK/rO1law9dY4gP44tgzg==',1,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR2',N'पुणे विभाग','8NK/rO1law9dY4gP44tgzg==',2,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR3',N'कोल्हापूर विभाग','8NK/rO1law9dY4gP44tgzg==',3,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR4',N'नाशिक विभाग','8NK/rO1law9dY4gP44tgzg==',4,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR5',N'औरंगाबाद विभाग','8NK/rO1law9dY4gP44tgzg==',5,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR6',N'लातूर विभाग','8NK/rO1law9dY4gP44tgzg==',6,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR7',N'अमरावती विभाग','8NK/rO1law9dY4gP44tgzg==',7,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR8',N'नागपूर विभाग','8NK/rO1law9dY4gP44tgzg==',8,3,1,1)
insert into Users(UserName,Name,Password,DivisionId,RoleId,Status,ReportTo) values('DJR9',N'कोकण विभाग','8NK/rO1law9dY4gP44tgzg==',9,3,1,1)
go


insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR1',N'मुंबई शहर - 1','9PAG6f8yPnTuEpyNtiE8sw==',1,1,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR2',N'मुंबई शहर - 2','9PAG6f8yPnTuEpyNtiE8sw==',1,2,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR3',N'मुंबई शहर - 3','9PAG6f8yPnTuEpyNtiE8sw==',1,3,4,1,2)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR4',N'मुंबई शहर - 4','9PAG6f8yPnTuEpyNtiE8sw==',1,4,4,1,2)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR5',N'पुणे शहर','9PAG6f8yPnTuEpyNtiE8sw==',2,5,4,1,3)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR6',N'पुणे ग्रामिण','9PAG6f8yPnTuEpyNtiE8sw==',2,6,4,1,3)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR7',N'सोलापूर','9PAG6f8yPnTuEpyNtiE8sw==',2,7,4,1,3)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR8',N'कोल्हापूर','9PAG6f8yPnTuEpyNtiE8sw==',3,8,4,1,4)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR9',N'सातारा','9PAG6f8yPnTuEpyNtiE8sw==',3,9,4,1,4)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR10',N'सांगली','9PAG6f8yPnTuEpyNtiE8sw==',3,10,4,1,4)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR11',N'नाशिक','9PAG6f8yPnTuEpyNtiE8sw==',4,11,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR12',N'धुळे','9PAG6f8yPnTuEpyNtiE8sw==',4,12,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR13',N'नंदुरबार','9PAG6f8yPnTuEpyNtiE8sw==',4,13,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR14',N'जळगाव','9PAG6f8yPnTuEpyNtiE8sw==',4,14,4,1,5)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR15',N'अहमदनगर','9PAG6f8yPnTuEpyNtiE8sw==',4,15,4,1,5)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR16',N'औरंगाबाद','9PAG6f8yPnTuEpyNtiE8sw==',5,16,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR17',N'जालना','9PAG6f8yPnTuEpyNtiE8sw==',5,17,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR18',N'परभणी','9PAG6f8yPnTuEpyNtiE8sw==',5,18,4,1,6)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR19',N'हिंगोली','9PAG6f8yPnTuEpyNtiE8sw==',5,19,4,1,6)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR20',N'लातूर','9PAG6f8yPnTuEpyNtiE8sw==',6,20,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR21',N'उस्मानाबाद','9PAG6f8yPnTuEpyNtiE8sw==',6,21,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR22',N'नांदेड','9PAG6f8yPnTuEpyNtiE8sw==',6,22,4,1,7)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR23',N'बीड','9PAG6f8yPnTuEpyNtiE8sw==',6,23,4,1,7)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR24',N'अमरावती','9PAG6f8yPnTuEpyNtiE8sw==',7,24,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR25',N'अकोला','9PAG6f8yPnTuEpyNtiE8sw==',7,25,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR26',N'वाशिम','9PAG6f8yPnTuEpyNtiE8sw==',7,26,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR27',N'यवतमाळ','9PAG6f8yPnTuEpyNtiE8sw==',7,27,4,1,8)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR28',N'बुलढाणा','9PAG6f8yPnTuEpyNtiE8sw==',7,28,4,1,8)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR29',N'नागपूर','9PAG6f8yPnTuEpyNtiE8sw==',8,29,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR30',N'वर्धा','9PAG6f8yPnTuEpyNtiE8sw==',8,30,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR31',N'चंद्रपूर','9PAG6f8yPnTuEpyNtiE8sw==',8,31,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR32',N'भंडारा','9PAG6f8yPnTuEpyNtiE8sw==',8,32,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR33',N'गोंदीया','9PAG6f8yPnTuEpyNtiE8sw==',8,33,4,1,9)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR34',N'गडचिरोली','9PAG6f8yPnTuEpyNtiE8sw==',8,34,4,1,9)

insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR35',N'पालघर','9PAG6f8yPnTuEpyNtiE8sw==',9,35,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR36',N'ठाणे','9PAG6f8yPnTuEpyNtiE8sw==',9,36,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR37',N'रत्नागिरी','9PAG6f8yPnTuEpyNtiE8sw==',9,37,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR38',N'रायगड','9PAG6f8yPnTuEpyNtiE8sw==',9,38,4,1,10)
insert into Users(UserName,Name,Password,DivisionId,DistrictId,RoleId,Status,ReportTo) values('DDR39',N'सिंधुदुर्ग','9PAG6f8yPnTuEpyNtiE8sw==',9,39,4,1,10)
go
